  ...
  return (
    <>
      <div className=" w-full h-screen ">
        <img src={image1} alt="i1" className="  w-full h-full  object-cover" />
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
          <h1 className="text-white text-3xl  md:text-5xl font-extrabold mb-4 bg-blue-500 p-4 rounded-2xl">
      ...
      <div className="w-full bg-gray-100  ">
        <div className="p-5 sm:text-lg md:text-2xl text-center bg-gray-300">
